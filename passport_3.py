...
move_pid = PID(0.01, 0, 0)
move_pid.set_sample_time(0.1)
move_pid.SetPoint = 400 # drone stays 400mm from wall
...
while True:
    ...
    for i in range(50):
        ...
        #no shifty_output and shiftx_output
        # tello.send_rc_control(0, -move_output, 0, 0)
        # sleep(0.1)
        # tello.send_rc_control(0, 0, 0, 0)
